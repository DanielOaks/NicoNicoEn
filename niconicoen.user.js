...
***/
{
    if(window.location.hostname == 'nivent.nicovideo.jp') {
      ...
      target = 'topline'
            ...
            (window.location.hostname == 'myapp.nicovideo.jp') ||
    ...
    ***/
    ...
    if(window.location.hostname == 'www.nicovideo.jp') {
      ...
      // Links
      trans.add('s', 'ニコニコアプリのトップページ', 'Home') // title
      trans.add('s', 'トップ', 'Home')
      trans.add('s', 'ニコニコポイント購入', 'Purchase Points')

      // Menu
      trans.add('s', 'あなたが遊んでいるアプリの一覧', 'Your Played Apps') // title
      trans.add('s', '遊んでいるアプリ', 'Played Apps')
   }
    else if(window.location.hostname == 'ichiba.nicovideo.jp') {
